...
//
//        ArrayList<String> message = bundle.getStringArrayList("message");
//        ArrayAdapter<String> items = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,message);
